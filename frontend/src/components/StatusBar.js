			...
			<div className="statusBar__wrapper">
					...
					{gameMode === "Online" && (
						<div className="rackInfo">
							...
							{highestScoringWord.word.length > 0 && (
								<div className="hiScore">{`'${highestScoringWord.word.toUpperCase()}' - ${highestScoringWord.points}pts`}</div>
							)}
				...
				<div className={turn === currentPlayer ? "statusBar__player player__active" : "statusBar__player"}>
					...
					<div className="player__score">
						...
						{lang === "tr" && "Skor:"}
						{lang === "fr" && "Score:"}
						{lang === "de" && "Punktzahl:"}&nbsp;&nbsp;&nbsp; {scores && scores[currentPlayer == 1 ? 1 : 0]}
					</div>
				</div>
              ...
              handleTimeOut={handleTimeOut}
					...
					<div className="player__score">
						...
						{lang === "tr" && "Skor:"}
						{lang === "fr" && "Score:"}
						{lang === "de" && "Punktzahl:"}&nbsp;&nbsp;&nbsp; {scores && scores[currentPlayer == 1 ? 0 : 1]}
					</div>
				</div>
			</div>
		</div>
